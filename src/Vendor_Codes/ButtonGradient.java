...
//    }
    ...
    private void createStyle(Graphics2D g2) {
        ...
        int width = getWidth();
        int height = getHeight();
        GradientPaint gra = new GradientPaint(0, 0, new Color(255, 255, 255, 90), 0, height, new Color(255, 255, 255, 60));
        g2.setPaint(gra);
        Path2D.Float f = new Path2D.Float();
        f.moveTo(0, 0);
        int controll = height + height / 2;
        ...
        // Set the font size and style for the button text
        Font font = new Font(getFont().getName(), Font.BOLD, 14);
        g2.setFont(font);
        g2.setColor(Color.BLACK); // Set the color of the button text
    }
